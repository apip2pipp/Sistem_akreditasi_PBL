<form id="form-edit" action="{{ route('kjm.update', $mKjm->kjm_id) }}" method="post">
    @csrf
    @method('PUT')
    ...
    <div id="modal-edit" class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Edit Data KJM</h5>
            ...
            <div class="modal-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-10">
                        <input type="text" class="form-control" name="kjm_nama" value="{{ $mKjm->kjm_nama }}">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-10">
                        <input type="text" class="form-control" name="no_pegawai" value="{{ $mKjm->no_pegawai }}">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-10">
                        <input type="email" class="form-control" name="kjm_email" value="{{ $mKjm->kjm_email }}">
                        ...
                        <select class="form-control" name="level_id">
                            ...
                            @foreach ($levels as $level)
                                <option value="{{ $level->level_id }}"
                                    {{ $mKjm->user && $mKjm->user->level_id == $level->level_id ? 'selected' : '' }}>
                                    {{ $level->level_nama }}
                                </option>
                            @endforeach
                        </select>
