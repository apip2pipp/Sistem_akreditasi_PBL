<form id="form-edit" action="{{ route('kaprodi.update', $mKaprodi->kaprodi_id) }}" method="post">
    @csrf
    @method('PUT')
    ...
    <div id="modal-edit" class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Edit Data Kaprodi</h5>
            ...
            <div class="modal-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-10">
                        <input type="text" class="form-control" name="kaprodi_nama"
                            value="{{ $mKaprodi->kaprodi_nama }}" required>
                    ...
                    <div class="col-10">
                        <select class="form-control" name="kaprodi_prodi" required>
                            ...
                            <option value="D-IV Teknik Informatika"
                                {{ $mKaprodi->kaprodi_prodi == 'D-IV Teknik Informatika' ? 'selected' : '' }}>D-IV
                                Teknik Informatika</option>
                            <option value="D-IV Sistem Informasi Bisnis"
                                {{ $mKaprodi->kaprodi_prodi == 'D-IV Sistem Informasi Bisnis' ? 'selected' : '' }}>D-IV
                                Sistem Informasi Bisnis</option>
                            <option value="D-II Pengembangan Perangkat Lunak"
                                {{ $mKaprodi->kaprodi_prodi == 'D-II Pengembangan Perangkat Lunak' ? 'selected' : '' }}>
                                D-II Pengembangan Perangkat Lunak</option>
                        </select>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-10">
                        <input type="email" class="form-control" name="kaprodi_email"
                            value="{{ $mKaprodi->kaprodi_email }}" required>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-10">
                        <select class="form-control" name="kaprodi_gender" required>
                            ...
                            <option value="L" {{ $mKaprodi->kaprodi_gender == 'L' ? 'selected' : '' }}>Laki-laki
                            </option>
                            <option value="P" {{ $mKaprodi->kaprodi_gender == 'P' ? 'selected' : '' }}>Perempuan
                            </option>
                        </select>
                 ...
                 <div class="form-group row">
                    ...
                    <div class="col-10">
                        <input type="text" class="form-control" name="username" value="{{ $mKaprodi->user->username ?? '' }}" required>
                        ...
                        <select class="form-control" name="level_id" required>
                            ...
                            @foreach ($levels as $level)
                                <option value="{{ $level->level_id }}"
                                    {{ $mKaprodi->user && $mKaprodi->user->level_id == $level->level_id ? 'selected' : '' }}>
                                    {{ $level->level_nama }}
                                </option>
                            @endforeach
                        </select>
