<form id="form-tambah" action="{{ route('penelitian-dosen-koordinator.store') }}" method="post">
    @csrf

    <div id="modal-master" class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Tambah Data Penelitian Dosen</h5>
            ...
            <div class="modal-body">
                <div class="form-group required row mb-2">
                    ...
                    <div class="col-10">
                        <select id="dosen_id" name="dosen_id[]" class="form-control select2" multiple>
                ...
                {{-- <div class="form-group row">
                    <label class="col-2 control-label col-form-label">Dosen</label>
                    <div class="col-10">
                        <select name="dosen_id[]" class="select2-selection--multiple" multiple required
                            style="width: 100%;">
                            @foreach ($dataDosen as $dosen)
                                <option value="{{ $dosen->dosen_id }}">{{ $dosen->dosen_nama }}</option>
                            @endforeach
